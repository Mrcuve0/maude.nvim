...
M.set = function()
    ...
    hl('NormalFloat', { fg = colors.dark_3, bg = colors.light_0 })
    hl('FloatBorder', { fg = colors.dark_3, bg = colors.light_2 })
    hl('ColorColumn', { bg = colors.light_3 })
    hl('Cursor', { fg = colors.light_5, bg = colors.dark_2 })
    hl('CursorLine', { bg = vim.g.maude_disable_cursorline and 'none' or colors.light_3 })
    ...
    hl('NotifyBackground', { fg = colors.dark_3, bg = colors.light_0 })
