...
M.set = function()
    ...
    hl('DiffAdd', { fg = colors.green_1, bg = colors.green_6 })
    hl('DiffChange', { fg = colors.orange_1, bg = colors.maude_dark_alt })
    hl('DiffDelete', { fg = colors.red_1, bg = colors.red_5 })
    hl('DiffText', { fg = colors.orange_4, bold = true, bg = colors.maude_dark_alt })
    ...
    hl('@function.macro', { fg = colors.chameleon_3, bold = true, bold = true })
    ...
    -- Zig
    hl('@function.call.zig', { fg = colors.chameleon_3, bold = true })
